...
<head>
	...
	<link rel="stylesheet" href="{{ asset('css/main.css?20190501_02') }}" />
...
<body>
	@if(session('success'))
		<input type="hidden" id="alert_custom" value="{{ session('success') }}"/>
	@endif
	<!-- Sidebar -->
	<section id="sidebar">
		<div class="inner">
		...
		<section id="three" class="wrapper style1 fade-up">
			<div class="inner">
				...
				<div class="split style1">
					<section>
						<form method="post" action="{{ action('Message@InsertMessage') }}" onsubmit="return validationCheck();">
					...
					<section>
						<ul class="contact">
							...
							<li>
								<h3>Email</h3>
								<span>fzl7808777@gmail.com</span>
							</li>
							<!-- <li>
											<h3>Phone</h3>
	...
	<footer id="footer" class="wrapper style1-alt">
		<div class="inner">
			<ul class="menu">
				<li>MAKHEE.IM All rights reserved.</li>
